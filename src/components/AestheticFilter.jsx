...
// Applies to any language: Japanese, Traditional Chinese, Simplified Chinese, etc.
const SET_EN_NAMES = {
  ...
  // ── Chinese (Simplified) Gem Pack exclusives ─────────────────────────────
  'zh-CBB1':  'Gem Pack Vol. 1',
  'zh-CBB2':  'Gem Pack Vol. 2',
  'zh-CBB3':  'Gem Pack Vol. 3',
  'zh-CBB4':  'Gem Pack Vol. 4',
  'zh-CBB5':  'Gem Pack Vol. 5',

  // ── Chinese Simplified (zh-cn) Scarlet & Violet ──────────────────────────
  'zh-cn-SV1S':  'Scarlet ex',
  'zh-cn-SV1V':  'Violet ex',
  'zh-cn-SV2D':  'Clay Burst',
  'zh-cn-SV2P':  'Snow Hazard',
  'zh-cn-SV2a':  'Pokémon Card 151',
  'zh-cn-SV3':   'Obsidian Flames',
  'zh-cn-SV3a':  'Raging Surf',
  'zh-cn-SV4K':  'Ancient Roar',
  'zh-cn-SV4M':  'Future Flash',
  'zh-cn-SV4a':  'Shiny Treasure ex',
  'zh-cn-SV5K':  'Wild Force',
  'zh-cn-SV5a':  'Crimson Haze',
  'zh-cn-SV6':   'Mask of Change',
  'zh-cn-SV6a':  'Night Wanderer',
  ...
  'zh-cn-SV9a':  'Sizzling Showdown',
  'zh-cn-SV10':  'Glory of Team Rocket',

  // ── Chinese Traditional (zh-tw) Scarlet & Violet ─────────────────────────
  'zh-tw-SV1S':  'Scarlet ex',
  'zh-tw-SV1V':  'Violet ex',
  'zh-tw-SV2D':  'Clay Burst',
  'zh-tw-SV2P':  'Snow Hazard',
  'zh-tw-SV2a':  'Pokémon Card 151',
  'zh-tw-SV3':   'Obsidian Flames',
  ...
  'zh-tw-SV9a':  'Sizzling Showdown',
  'zh-tw-SV10':  'Glory of Team Rocket',
  // zh-tw SV special sets
  'zh-tw-SV-P':  'Promo Cards: Scarlet & Violet',
  'zh-tw-SVB':   'Premium Trainer Box ex',
  'zh-tw-SVC':   'Pikachu Special Set',
  'zh-tw-SVD':   'ex Starter Deck',
  'zh-tw-SVP1':  'ex Special Set',
  'zh-tw-SVAM':  'Starter Set ex: Sprigatito & Lucario ex',
  'zh-tw-SVAL':  'Starter Set ex: Fuecoco & Miraidon ex',
  'zh-tw-SVAW':  'Starter Set ex: Quaxly & Mimikyu ex',
  'zh-tw-SVF':   'Ruler of the Black Flame (mini)',
  'zh-tw-SVEM':  'Mewtwo ex (mini)',
  'zh-tw-SVEL':  'Skeledirge ex (mini)',
  'zh-tw-SVHM':  'Shiny Treasure ex (mini)',
  'zh-tw-SVHK':  'Future Miraidon ex (mini)',

  // ── Chinese Traditional (zh-tw) Sword & Shield ───────────────────────────
  'zh-tw-S12a':  'VSTAR Universe',
  'zh-tw-S12':   'Paradigm Trigger',
  'zh-tw-S11a':  'Lost Abyss',
  'zh-tw-S11':   'Incandescent Arcana',
  'zh-tw-S10b':  'Pokémon GO',
  'zh-tw-S10a':  'Dark Phantasma',
  'zh-tw-S10D':  'Time Gazer',
  'zh-tw-S10P':  'Space Juggler',
  'zh-tw-S9a':   'Battle Region',
  'zh-tw-S9':    'Star Birth',
  'zh-tw-S8b':   'VMAX Climax',
  'zh-tw-S8a':   '25th Anniversary Collection',
  'zh-tw-S8':    'Fusion Strike',
  'zh-tw-S7R':   'Blue Sky Stream',
  'zh-tw-S7D':   'Towering Perfection',
  'zh-tw-S6a':   'Eevee Heroes',
  'zh-tw-S6H':   'Silver Lance',
  'zh-tw-S6K':   'Jet Black Poltergeist',
  'zh-tw-S5a':   'Matchless Fighters',
  'zh-tw-S5I':   'Single Strike Master',
  'zh-tw-S5R':   'Rapid Strike Master',
  'zh-tw-S4a':   'Shiny Star V',
  'zh-tw-S4':    'Shocking Volt Tackle',
  // zh-tw S&S special sets
  'zh-tw-SK':    'Premium Trainer Box VSTAR',
  'zh-tw-SJ':    'Zacian V vs. Zamazenta V',
  'zh-tw-SI':    'Starter Set V 100',
  'zh-tw-SLD':   'VSTAR Starter Set: Darkrai',
  'zh-tw-SLL':   'VSTAR Starter Set: Lucario',
  'zh-tw-SN':    'Starter Set 100 Special Edition',
  'zh-tw-SDP':   'VMAX Climax: Pikachu',
  'zh-tw-SDL':   'VMAX Climax: Charizard',
  'zh-tw-SDM':   'VMAX Climax: Mewtwo',
  'zh-tw-SCC':   'Evolution',
  'zh-tw-SCB':   'Challenge',
  'zh-tw-SCA':   'Partners',
  'zh-tw-SCD':   'Powerful',
  'zh-tw-SH':    'Pokémon Card Family Set',
  'zh-tw-SP5':   'Powerful (Promo)',
  'zh-tw-SPZ':   'VSTAR & VMAX High-Class Deck: Zeraora',
  'zh-tw-SPD':   'VSTAR & VMAX High-Class Deck: Deoxys',
  'zh-tw-SP6':   'VSTAR Special Set',
  'zh-tw-SC2D':  'Infinity Zone',
  'zh-tw-SC2b':  'Infinity Zone Set B',
  'zh-tw-SC2a':  'Infinity Zone Set A',
