  ...
  return (
    <div className="px-4 py-6 max-w-4xl mx-auto space-y-5">
      ...
      >
        <button
          onClick={() => onNavigate('all')}
          className="flex items-center gap-3 bg-white/70 hover:bg-white border border-gray-100
                     rounded-2xl p-4 shadow-sm transition-all text-left"
        >
          <span className="text-2xl">🌐</span>
          <div>
            <p className="font-semibold text-gray-700 text-sm">Browse All Cards</p>
            <p className="text-xs text-gray-400">Every Pokémon, every set</p>
          </div>
        </button>

        <button
          onClick={() => onNavigate('fullart')}
          className="flex items-center gap-3 bg-gradient-to-r from-fuchsia-50 to-pink-50
                     hover:from-fuchsia-100 hover:to-pink-100
                     border border-fuchsia-200 rounded-2xl p-4 shadow-sm transition-all text-left"
        >
          <span className="text-2xl">🎨</span>
          <div>
            <p className="font-semibold text-fuchsia-700 text-sm">Full Art & Rare Finds</p>
            <p className="text-xs text-fuchsia-400">SR · IR · Hyper Rare</p>
          </div>
        </button>
      </motion.div>
